      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a href="#" className="text-sm text-gray-700 hover:text-primary-600 whitespace-nowrap">로그인</a>
            <a href="#" className="text-sm text-gray-700 hover:text-primary-600 whitespace-nowrap">회원가입</a>
            <a href="#" className="btn-primary text-sm whitespace-nowrap">My Study</a>
          </div>
        ...
        <div className="lg:hidden bg-white border-t">
          <div className="container-custom py-4 space-y-2">
            ...
            <div className="pt-4 border-t space-y-2">
              <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-primary-50 rounded whitespace-nowrap">로그인</a>
              <a href="#" className="block px-4 py-2 text-gray-700 hover:bg-primary-50 rounded whitespace-nowrap">회원가입</a>
              <a href="#" className="block px-4 py-2 btn-primary text-center whitespace-nowrap">My Study</a>
            </div>
          </div>
        </div>
      )}
